...
private:
	...
	void onImageMsg(const sensor_msgs::msg::Image::SharedPtr msg)
	{
		...
		bram_object.pic2bram(img);

		// write data to bram
		//!int temp = sleep_time;
		

		while (bram_object[128] == 4);
		...
		*/
		...
		label = bram_object[128];
		RCLCPP_INFO(this->get_logger(), "Label" + std::to_string(label));
